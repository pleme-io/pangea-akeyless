...
require 'pangea/resources/akeyless_rotated_secret_hanadb/types'
require 'pangea/resource_registry'

module Pangea::Resources
  module AkeylessRotatedSecretHanadb
    include Pangea::Resources::ResourceBuilder

    define_resource :akeyless_rotated_secret_hanadb,
      attributes_class: Akeyless::Types::RotatedSecretHanadbAttributes,
