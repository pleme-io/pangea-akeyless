...
require 'pangea/resources/akeyless_rotated_secret_mongo/types'
require 'pangea/resource_registry'

module Pangea::Resources
  module AkeylessRotatedSecretMongo
    include Pangea::Resources::ResourceBuilder

    define_resource :akeyless_rotated_secret_mongo,
      attributes_class: Akeyless::Types::RotatedSecretMongoAttributes,
