...
require 'pangea/resources/akeyless_rotated_secret_mssql/types'
require 'pangea/resource_registry'

module Pangea::Resources
  module AkeylessRotatedSecretMssql
    include Pangea::Resources::ResourceBuilder

    define_resource :akeyless_rotated_secret_mssql,
      attributes_class: Akeyless::Types::RotatedSecretMssqlAttributes,
