...
require 'pangea/resources/akeyless_rotated_secret_oracle/types'
require 'pangea/resource_registry'

module Pangea::Resources
  module AkeylessRotatedSecretOracle
    include Pangea::Resources::ResourceBuilder

    define_resource :akeyless_rotated_secret_oracle,
      attributes_class: Akeyless::Types::RotatedSecretOracleAttributes,
