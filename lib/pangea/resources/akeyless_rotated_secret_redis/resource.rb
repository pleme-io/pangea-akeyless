...
require 'pangea/resources/akeyless_rotated_secret_redis/types'
require 'pangea/resource_registry'

module Pangea::Resources
  module AkeylessRotatedSecretRedis
    include Pangea::Resources::ResourceBuilder

    define_resource :akeyless_rotated_secret_redis,
      attributes_class: Akeyless::Types::RotatedSecretRedisAttributes,
