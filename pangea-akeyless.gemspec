...
Gem::Specification.new do |spec|
  ...
  spec.description           = %(Akeyless provider resources for Pangea infrastructure DSL. Provides 119 typed Terraform resource functions with Dry::Struct validation. Auto-generated by pangea-forge.)
